#after attaching camera to the stand, it counts pixels from the right  ( so the higher values are on the left) for the x direction
#also going downwards in the image increases y value so the y pixels are counted from the top
