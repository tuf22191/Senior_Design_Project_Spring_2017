...
def getDistance( pixelValue  ,   pToCmTable): #tested and works
    ...
    if(isLargerThanLastValue): #we have to use last marker
        return pToCmTable[10][1]+ 0.0 +(( pixelValue - pToCmTable[10][0] +0.0)/(pToCmTable[10][0] - pToCmTable[10-1][0]+0.0))*10.0
        ...
        while True:
            ...
            if(had_counter):
                if(start_time_speed!=None): #end the timer #high priority
                    ...
                    y_max_value = getDistance(y_max_value, pixelToCentimeterTable)
                    y_min_value = getDistance(y_min_value, pixelToCentimeterTable)
                    x_min_value = getDistance(x_min_value, pixelToCentimeterTable)
                    x_max_value = getDistance(x_max_value, pixelToCentimeterTable)
